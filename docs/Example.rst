...
We look at the examples in the example_scripts folder of the Github repository.
...
.. literalinclude:: ../example_scripts/Single_trajectory.py
   :language: python
...
.. literalinclude:: ../example_scripts/Multiple_trajectories.py
   :language: python
...
.. literalinclude:: ../example_scripts/Scale_SS_Main.py
   :language: python
